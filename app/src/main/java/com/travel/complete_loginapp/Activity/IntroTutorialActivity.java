...
import com.travel.complete_loginapp.Adapters.SliderAdapter;
...
public class IntroTutorialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Code checking if user opened app First time
    ...
    private void changeActivity() {
        Intent intent = new Intent(IntroTutorialActivity.this, MainActivity.class);
